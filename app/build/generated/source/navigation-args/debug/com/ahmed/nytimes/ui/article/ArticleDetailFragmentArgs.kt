...
public data class ArticleDetailFragmentArgs(
  ...
  public companion object {
    ...
    public fun fromBundle(bundle: Bundle): ArticleDetailFragmentArgs {
      ...
      return ArticleDetailFragmentArgs(__article)
    }

    @JvmStatic
    public fun fromSavedStateHandle(savedStateHandle: SavedStateHandle): ArticleDetailFragmentArgs {
      val __article : Article?
